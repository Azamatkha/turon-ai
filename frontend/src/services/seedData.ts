...
export const seedAdminUsers: AdminUser[] = [
  { id: "1", name: "Aziz Karimov", handle: "@a.karimov", dept: "Chakana", role: "Xodim", status: "Offline", verified: true },
  { id: "2", name: "Malika Yusupova", handle: "@m.yusupova", dept: "IT", role: "Admin", status: "Offline", verified: true },
  { id: "3", name: "Dilshod Tashkentov", handle: "@d.tashkentov", dept: "Korporativ", role: "Xodim", status: "Offline", verified: true },
];
