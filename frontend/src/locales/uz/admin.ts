...
export const admin = {
  ...
  taken: "Band",
  create: "Yaratish",
  roleLabel: { Agent: "Agent", Manager: "Menejer", Admin: "Admin" } as Record<AdminRole, string>,
  statusLabel: { Active: "Faol", Invited: "Taklif qilingan", Suspended: "To‘xtatilgan" } as Record<AdminStatus, string>,
} as const;
