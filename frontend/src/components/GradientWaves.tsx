...
const GradientWaves: React.FC<GradientWavesProps> = ({
  ...
  useEffect(() => {
    ...
    // WebGL2 bo'lmagan muhitda (eski GPU, masofaviy ish stoli) butun sahifa
    // yiqilmasin — fon shunchaki chizilmaydi.
    ...
    // Kursor `window` da kuzatiladi, canvas'da emas: fon qatlami odatda
    // `pointer-events: none` bo'ladi (bosishlarni to'smasligi uchun), shunda
    // canvas hech qanday pointer hodisasini olmaydi va parallaks ishlamaydi.
