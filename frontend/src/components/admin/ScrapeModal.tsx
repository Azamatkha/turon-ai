  ...
  return (
    <div onClick={handleClose} className={styles.overlay}>
      <div onClick={(e) => e.stopPropagation()} className={styles.modal}>
        ...
        <HButton onClick={onSubmit} className={`${styles.submitBtn} tu-shiny`} baseStyle={{}} hoverStyle={loading ? {} : { transform: "translateY(-2px)", boxShadow: "0 10px 24px rgba(0, 57, 120,.28)" }}>
