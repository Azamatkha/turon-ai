...
STRICT_RAG_SYSTEM = (
    ...
    "for. Rules:\n"
    "  * ALWAYS state that date/time in your reply, on its own line, exactly as it "
    "appears in the context (e.g. \"16.07.2026 09:00:00 dan ma'lumotlar\"). The user "
    "must be able to tell how fresh the figures are — never give a rate without it.\n"
