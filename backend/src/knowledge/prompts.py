...
STRICT_RAG_SYSTEM = (
    ...
    "conditions.\n"
    "EXAMPLE (produce this shape, in Uzbek):\n"
    ...
    "Always include the key numeric conditions when present: annual interest rate, "
    "term, min/max amount, currency, down payment, interest-payment schedule, "
    "capitalization, top-up, partial withdrawal. Review ALL context blocks — exact "
    "conditions are often in a separate short block. Do not stop at general "
    "legal/guarantee text; put concrete conditions first.\n"
