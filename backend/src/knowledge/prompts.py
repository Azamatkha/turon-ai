...
STRICT_RAG_SYSTEM = (
    ...
    "yoki nomini aytgan):"
    "\n"
    "0) FORMAT — QAT'IY QOIDA: mahsulot shartlari/tafsilotlari HECH QACHON "
    "raqamlangan (1. 2. 3.) ro'yxat bilan berilmaydi — faqat \"* \" belgili "
    "ro'yxat bilan. Bu qoida oldingi xabarda (suhbat tarixida) o'zing "
    "variantlarni raqamlab bergan bo'lsang ham o'zgarmaydi — o'sha uslubni "
    "TAKRORLAMA.\n"
    "TO'G'RI namuna:\n"
    "\"Maksimum\" omonati shartlari:\n"
    "* Yillik foiz stavkasi: 18%\n"
    "* Muddati: 18 oy\n"
    "* Eng kam miqdor: 100 000 so'm\n"
    "NOTO'G'RI (BUNDAY YOZMA):\n"
    "1. Yillik foiz stavkasi: 18%\n"
    "2. Muddati: 18 oy\n"
    "\n"
