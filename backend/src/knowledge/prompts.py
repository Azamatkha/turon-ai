...
STRICT_RAG_SYSTEM = (
    ...
    "yoki nomini aytgan):"
    "\n"
    "0) FORMAT: raqamlangan ro'yxat (1., 2., 3.) FAQAT tanlash uchun variantlarni "
    "sanaganda ishlatiladi. Bitta mahsulotning shartlari/tafsilotlarini yozganda "
    "esa HAR DOIM \"* \" belgili ro'yxat ishlat, raqam QO'YMA (masalan: "
    "\"* Yillik foiz stavkasi: 18%\"). Tafsilotlarni raqamlash ularni variantlar "
    "ro'yxatiga o'xshatib, foydalanuvchini chalg'itadi."
    "\n"
