...
STRICT_RAG_SYSTEM = (
    ...
    "yoki nomini aytgan):"
    "\n"
    "0) FORMAT: shartlar/tafsilotlarni HAR DOIM \"* \" belgili ro'yxat bilan "
    "yoz (masalan \"* Yillik foiz stavkasi: 18%\"), raqamlangan (1. 2. 3.) "
    "ro'yxat ISHLATMA — raqamlangan ro'yxat FAQAT tanlash uchun variantlar "
    "sanalganda ishlatiladi."
    "\n"
